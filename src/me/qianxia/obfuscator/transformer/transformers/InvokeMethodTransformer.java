...
public class InvokeMethodTransformer extends Transformer {
	...
	for (ClassNode classNode : classes.values()) {
		...
		for (AbstractInsnNode abstractInsnNode : methodNode.instructions) {
		    ...
		    MethodNode method = new MethodNode(Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, randomName,
		    ...
		    method.visitMethodInsn(Opcodes.INVOKESTATIC, methodInsnNode.owner, methodInsnNode.name,
			    methodInsnNode.desc);
		    ...
		    methodNode.instructions.insertBefore(abstractInsnNode, new MethodInsnNode(Opcodes.INVOKESTATIC,
			    methodCallsClassNode.name, randomName, methodInsnNode.desc, false));
